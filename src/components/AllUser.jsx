...
function AllHR() {
  ...
  const onHandleAvailabilityChange = (id, availability) => {
        ...
        <div className="p-2 md:p-5 w-full sm:ml-2 md:ml-2 mt-3">
              ...
              <div className="flex flex-col lg:flex-row w-full md:w-11/12 px-2 py-2 bg-white shadow rounded-md">
                <div className="w-full flex items-center">
                  ...
                  <input
                    ...
                    className="px-4 py-2 outline-0 md:border-r-1 border-gray-300 w-full"
                    value={searchTerm}
          ...
          <div className="w-full flex flex-wrap gap-4 pt-5 gap-y-6">
            {userData.map((item, index) => {
              return (
                <UserDetails
                  onHandleAvailabilityChange={onHandleAvailabilityChange}
                  item={item}
                  key={index}
                />
              );
